...
def add_persons(backup_dir, faces_save_dir, features_path):
    """
    ...
    for name_person in os.listdir(backup_dir):
        person_image_path = os.path.join(backup_dir, name_person)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--backup-dir",
        type=str,
        default="D:/magang/comvis/datasets/backup",
        help="Directory to save person data.",
    )
    # parser.add_argument(
    #     "--add-persons-dir",
    #     type=str,
    #     default="D:/magang/comvis/datasets/new_persons",
    #     help="Directory to add new persons.",
    # )
    parser.add_argument(
        "--faces-save-dir",
        type=str,
        default="D:/magang/comvis/datasets/data/",
        help="Directory to save faces.",
    )
    parser.add_argument(
        "--features-path",
        type=str,
        default="D:/magang/comvis/datasets/face_features/feature",
